...
const commonDocsOptions = {
  ...
  editUrl: "https://github.com/fleekxyz/fleek-xyz-docs/",
};
...
const config = {
  ...
  tagline:
    "Welcome to the docs of Fleek. Seamlessly build Web3 apps and services that are edge-optimized for performance.",
